...
def find_initial_velocity(ball_initial_position: np.array, ball_horizontal_speed_mph, ball_target_position: np.array):
    ...
    vz = ball_initial_speed * displacement[2] / horizontal_distance - 0.5 * gravity_velocity
